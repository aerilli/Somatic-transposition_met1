...
done < /ebio/abt6_projects/met1_somatic_transpositions/data/3_somatic-events/r_mutations/insertion-bias/Accessibility_bias/ATAC-Seq/ATAC_batch1.Tsu_P2.txt
