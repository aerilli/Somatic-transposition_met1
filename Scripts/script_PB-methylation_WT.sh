...
OUTDIR=$1 #/ebio/scratch/amovilli/mC/WT
movie_seq=$2 
#movie_reseq=$3 
OUT=$3 #tsumet
REF=$4 #/ebio/abt6_projects/met1_somatic_transpositions/data/1_genome/2_hifiasm_ragtag/Tsu-0/Tsu-0.Chr_scaffolds.v2.fa
CORES=$5
...
lima $OUTDIR/$ccsout_merged_hifi /ebio/abt6_projects/Ath_HiFi_met1/data/assembly/barcodes/bc1010.fasta $OUTDIR/$ccsout_merged_hifi_demux \
--same --ccs --min-score 70 --min-scoring-regions 2 --min-ref-span 0.8 --peek-guess --split-bam-named -j 64
